package notq.dccast.screens.navigation_menu.cast.user_follow;
...
import notq.dccast.databinding.ActivityUserFollowBinding;
...
public class ActivityUserFollow extends BaseActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    binding = DataBindingUtil.setContentView(this, R.layout.activity_user_follow);
  ...
  private void initToolbar() {
    ...
    binding.header.lblHeader.setText(getString(R.string.activity_user_follow));
