...
import notq.dccast.databinding.VhNotificationLiveItemBinding;
...
public class AdapterNotificationLive
    ...
    public AdapterNotificationLive(Context context, NotificationNoticeListener adapterListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEW_TYPE_ITEM: {
                VhNotificationLiveItemBinding binding =
                    DataBindingUtil.inflate(inflater, R.layout.vh_notification_live_item, parent,
                        false);
                return new ViewHolderNotificationLive(binding);
            }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        switch (getItemViewType(position)) {
            case VIEW_TYPE_ITEM: {
                ((ViewHolderNotificationLive) holder).setData(notifications.get(position),
                    position);
                break;
            }
    ...
    class ViewHolderNotificationLive extends RecyclerView.ViewHolder
        implements View.OnClickListener {
        private VhNotificationLiveItemBinding binding;
        private int position;
        private ModelNotification modelNotification;

        ViewHolderNotificationLive(@NonNull VhNotificationLiveItemBinding binding) {
