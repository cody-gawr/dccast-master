...
import notq.dccast.databinding.FragmentBottomLockBinding;

public class BottomSheetLock extends Fragment {
  @SuppressLint("StaticFieldLeak")
  private FragmentBottomLockBinding binding;
  private String pin;
  ...
  public static synchronized BottomSheetLock getInstance(String pin) {
    BottomSheetLock instance = new BottomSheetLock();
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
    ...
    binding = DataBindingUtil.inflate(inflater, R.layout.fragment_bottom_lock, container, false);

    if (pin != null && !pin.isEmpty()) {
      binding.lblPin.setText(getString(R.string.verify_live_lock_password));
    }
