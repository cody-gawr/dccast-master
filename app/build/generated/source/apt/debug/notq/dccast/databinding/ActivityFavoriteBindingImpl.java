...
public class ActivityFavoriteBindingImpl extends ActivityFavoriteBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.layout_favourite, 3);
        sViewsWithIds.put(R.id.lbl_favorite, 4);
    ...
    public ActivityFavoriteBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private ActivityFavoriteBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
