...
public class ActivitySearchFriendBindingImpl extends ActivitySearchFriendBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.layout_item, 5);
        sViewsWithIds.put(R.id.lbl_result_count, 6);
        sViewsWithIds.put(R.id.recyclerView, 7);
        sViewsWithIds.put(R.id.layout_no_data, 8);
    ...
    public ActivitySearchFriendBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 10, sIncludes, sViewsWithIds));
    }
    private ActivitySearchFriendBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
