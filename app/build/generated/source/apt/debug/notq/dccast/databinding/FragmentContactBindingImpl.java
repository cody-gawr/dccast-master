...
public class FragmentContactBindingImpl extends FragmentContactBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.et_title, 2);
        sViewsWithIds.put(R.id.spinner_type, 3);
        sViewsWithIds.put(R.id.layout_information, 4);
        sViewsWithIds.put(R.id.et_information, 5);
        sViewsWithIds.put(R.id.lbl_img, 6);
        sViewsWithIds.put(R.id.btn_choose_image, 7);
        sViewsWithIds.put(R.id.btn_send, 8);
    }
    // views
    @NonNull
