...
public class ActivitySubscribeBindingImpl extends ActivitySubscribeBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.container_for_subscribe_video, 5);
        sViewsWithIds.put(R.id.layoutSearch, 6);
        sViewsWithIds.put(R.id.et_search, 7);
        sViewsWithIds.put(R.id.layout_sort, 8);
        sViewsWithIds.put(R.id.lbl_sort_value, 9);
        sViewsWithIds.put(R.id.refresher, 10);
        sViewsWithIds.put(R.id.recyclerView, 11);
        sViewsWithIds.put(R.id.layout_no_data, 12);
    ...
    public ActivitySubscribeBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 16, sIncludes, sViewsWithIds));
    }
    private ActivitySubscribeBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
