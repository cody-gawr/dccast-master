...
public class ActivityHomeBindingImpl extends ActivityHomeBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(1, 
            new String[] {"activity_home_toolbar"},
            new int[] {2},
            new int[] {notq.dccast.R.layout.activity_home_toolbar});
        sViewsWithIds = new android.util.SparseIntArray();
        sViewsWithIds.put(R.id.drawer_layout, 3);
        sViewsWithIds.put(R.id.container, 4);
        sViewsWithIds.put(R.id.navigation_drawer_recyclerview, 5);
    }
    // views
    @NonNull
    ...
    private ActivityHomeBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (androidx.drawerlayout.widget.DrawerLayout) bindings[3]
            , (androidx.recyclerview.widget.RecyclerView) bindings[5]
            , (notq.dccast.databinding.ActivityHomeToolbarBinding) bindings[2]
            );
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeToolbarContainer((notq.dccast.databinding.ActivityHomeToolbarBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeToolbarContainer(notq.dccast.databinding.ActivityHomeToolbarBinding ToolbarContainer, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
