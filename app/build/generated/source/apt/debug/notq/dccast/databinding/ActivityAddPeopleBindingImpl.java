...
public class ActivityAddPeopleBindingImpl extends ActivityAddPeopleBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.flex_layout, 3);
        sViewsWithIds.put(R.id.et_search_username, 4);
        sViewsWithIds.put(R.id.recyclerView, 5);
        sViewsWithIds.put(R.id.layout_member_load, 6);
        sViewsWithIds.put(R.id.dc_loader, 7);
    }
    // views
    @NonNull
    ...
    public ActivityAddPeopleBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private ActivityAddPeopleBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
