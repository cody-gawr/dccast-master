...
public class ActivityContactUsDetailBindingImpl extends ActivityContactUsDetailBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.contact_date, 5);
        sViewsWithIds.put(R.id.status, 6);
        sViewsWithIds.put(R.id.information, 7);
    ...
    public ActivityContactUsDetailBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }
    private ActivityContactUsDetailBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
